...
model = pickle.load(open("fmodel1.pkl", "rb"))
...
def home():
    ...
    return render_template("deployment.html", education_status=education_status, marital_status=marital_status,
